...
return [
    ...
    */
    ...
    'options' => [
         ...
         *
         * Enabled so DomPDF embeds only the glyphs actually used instead of the
         * full DejaVu Sans/Bold TTFs (~1.46 MB source, ~734 KB in the PDF). The
         * rendered appearance is identical; the file just gets much smaller.
         */
